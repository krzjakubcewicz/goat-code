---
description: Stop a goat-code run and clean up its worktrees
argument-hint: "[run-id] [--delete-branches]"
---

Abort a goat-code run.

1. Run `python "${CLAUDE_PLUGIN_ROOT}/scripts/goatcode.py" status $ARGUMENTS`
...
3. Run `python "${CLAUDE_PLUGIN_ROOT}/scripts/goatcode.py" abort $ARGUMENTS`.
