---
name: goat-code-verifier
description: >
  Judges the merged goat-code integration branch against every acceptance
...
Read `goat-code:goat-code-conventions`, then follow
...
Judge against the **Evidence standard** in `goat-code:goat-code-conventions`. It is
