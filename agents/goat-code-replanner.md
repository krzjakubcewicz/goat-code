---
name: goat-code-replanner
description: >
  Turns a failing goat-code verdict into the next cycle's tasks.yaml,
...
Read `goat-code:goat-code-conventions` for the tasks.yaml dialect and validation
